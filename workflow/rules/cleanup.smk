...
rule cleanup_single_end_reads:
	...
	output:
		...
		done="results/done/single_end/{single_reads}/done.txt"
	params:
	...
	threads: 1
	log:
		"results/done/{single_reads}_clean.log"
	shell:
		"""
...
rule cleanup_paired_end_reads:
	...
	output:
		...
		done="results/done/paired_end/{paired_reads}/done.txt"
	params:
		...
		time=config["time_path"]
	log: 
		"results/done/{paired_reads}_clean.log"
	shell:
		"""
